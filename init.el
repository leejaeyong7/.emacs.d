...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (column-marker cuda-mode cmake-mode esup org counsel ivy writeroom-mode yasnippet emmet-mode)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "gray17" :foreground "white smoke" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 151 :width normal :foundry "DAMA" :family "Ubuntu Mono"))))
